...
def get_snapshottable_plans(project):
    ...
    for plan in project.plans:
        ...
        try:
            # plans that autogenerate buildsteps have no steps, but they always generate a
            # LXCBuildStep, which is snapshottable
            if not (plan.autogenerated() or plan.steps[0].get_implementation().can_snapshot()):
