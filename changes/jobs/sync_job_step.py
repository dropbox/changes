...
def _expects_tests(jobplan):
    ...
    """
    # TODO(adai): In the future, autogenerated jobs will be expected to
    # return test results by default. This is currently disabled because
    # autogenerated jobs don't have tests yet.
    if not jobplan:
        return False
...
def has_timed_out(step, jobplan, default_timeout):
    ...
    options = jobplan.get_steps()[0].options if jobplan else {}
