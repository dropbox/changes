...
class BuildboxApp(flask.Flask):
    def __init__(self, *args, **kwargs):
        ...
        super(BuildboxApp, self).__init__(*args, **kwargs)
...
def create_app(**config):
    ...
    # app.config['UPLOAD_FOLDER'] = BUILDBOX_PATH + '/uploads'
...
def configure_web_routes(app):
    from buildbox.web.index import IndexView
