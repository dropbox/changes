...
class BuildRetryTest(APITestCase):
    ...
    @patch('changes.models.repository.Repository.get_vcs')
    def test_with_selective_testing_commit_builds(self, get_vcs, get_selective_testing_policy, contains_active_autogenerated_plan):
...
Selective testing was requested but not done because:
    ...
    @patch('changes.lib.project_lib.contains_active_autogenerated_plan')
    @patch('changes.models.repository.Repository.get_vcs')
    def test_with_selective_testing_diff_builds(self, get_vcs, contains_active_autogenerated_plan):
        contains_active_autogenerated_plan.return_value = True
        get_vcs.return_value = self.get_fake_vcs()
        project = self.create_project()
